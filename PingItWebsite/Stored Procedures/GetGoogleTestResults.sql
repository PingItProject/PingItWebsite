CREATE DEFINER=`root`@`%` PROCEDURE `GetGoogleTestResults`(IN ucity VARCHAR(100), IN ustate VARCHAR(10), IN ubrowser VARCHAR(25), IN uwebsite VARCHAR(100), IN ordering bool)
BEGIN
